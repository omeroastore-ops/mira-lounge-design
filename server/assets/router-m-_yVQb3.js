...
import { createRootRouteWithContext, useRouter, Link, Outlet, HeadContent, Scripts, createFileRoute, lazyRouteComponent, createRouter, createHashHistory } from "@tanstack/react-router";
...
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "fallback", children: /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "actions", children: [
      ...
      /* @__PURE__ */ jsx(Link, { to: "/", className: "btn btn-outline", children: "Startseite" })
    ] })
  ] }) });
}
...
const $$splitComponentImporter$3 = () => import("./impressum-fw-NkirA.js");
...
const $$splitComponentImporter$2 = () => import("./datenschutz-CnKx9C5c.js");
...
const $$splitComponentImporter$1 = () => import("./cookie-richtlinie-DtwYwCd9.js");
...
const $$splitComponentImporter = () => import("./index-B-NG4r89.js");
