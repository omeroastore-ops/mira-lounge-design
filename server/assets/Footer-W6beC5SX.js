...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxs("header", { className: `navbar ${scrolled ? "scrolled" : ""}`, children: [
    /* @__PURE__ */ jsxs("nav", { className: "navbar-inner", children: [
      /* @__PURE__ */ jsxs("a", { href: "/#home", className: "brand", children: [
        "MIRAÈ",
        /* @__PURE__ */ jsx("span", { className: "brand-sub", children: "LOUNGE" })
      ] }),
      /* @__PURE__ */ jsx("ul", { className: "nav-links", children: links.map((l) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: l.href, className: "nav-link", children: l.label }) }, l.href)) }),
    ...
    open && /* @__PURE__ */ jsx("div", { className: "nav-mobile", children: /* @__PURE__ */ jsxs("ul", { children: [
      links.map((l) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: l.href, onClick: () => setOpen(false), children: l.label }) }, l.href)),
