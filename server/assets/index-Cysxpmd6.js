...
function Hero() {
  return /* @__PURE__ */ jsxs("section", { id: "home", className: "hero", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "hero-content float-up", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "hero-actions", children: /* @__PURE__ */ jsx("a", { href: "#menu", className: "btn btn-primary", children: "Speisekarte entdecken" }) }),
...
const url$1 = "/__l5e/assets-v1/d9d1e137-4c12-4a6a-ae2e-35c4ad400523/interior-lounge.jpg";
const interior = {
  url: url$1
};
const url = "/__l5e/assets-v1/cd239c11-9467-46c4-be62-5a28245d7135/interior-shisha.jpg";
const shisha = {
  url
};
const features = [
...
function About() {
  return /* @__PURE__ */ jsx("section", { id: "about", className: "section", children: /* @__PURE__ */ jsxs("div", { className: "about-grid", children: [
    /* @__PURE__ */ jsxs("div", { className: "about-media", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "about-media-main", children: /* @__PURE__ */ jsx("img", { src: interior.url, alt: "Lounge Interior", loading: "lazy" }) }),
      /* @__PURE__ */ jsx("div", { className: "about-media-overlay", children: /* @__PURE__ */ jsx("img", { src: shisha.url, alt: "Shisha", loading: "lazy" }) })
    ] }),
